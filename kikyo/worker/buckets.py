# -*- coding: utf-8 -*-
"""
    kikyo.worker.buckets
    ~~~~~~~~~~~~~~~~~~~~~

    Most of the code is from celery
...
from kikyo.five import Queue, Empty, values, zip_longest
...
class TaskBucket(object):
    ...
    def _get(self):
        ...
        remaining_times = []
        # NOTE(by seckcoder) : There are some problems here: if we
        # put a huge number of tasks into a bucket, then the other
        # tasks in other buckets will never be executed
